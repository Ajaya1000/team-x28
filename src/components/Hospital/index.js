          ...
          >
            <ClickAwayListener onClickAway={handleClose}>
              ...
              >
                ...
                <Paper
                  className={
                    menu ? classes.listVisible : classes.listNotVisible
                  }
                >
                  {/* <ListItem */}
                  {selectedStatesList.map((item) => (
                    <ListItem
                      button
                      ...
                      onClick={() => {
                        ...
                        let temp = dataList.filter(
                          (data) =>
                            match(data.state, item) &&
                            (match(selectedType, 'All') ||
                              match(data.ownership, selectedType))
                        );
            ...
            <FormControl variant='outlined' className={classes.formControl}>
              ...
              <Select
                ...
                onChange={(e) => {
                  ...
                  let temp = dataList.filter(
                    (data) =>
                      match(data.state, selectedState) &&
                      match(data.ownership, item)
                  );
                  setFilteredList(temp);
                  console.log('temp ', temp);
                }}
